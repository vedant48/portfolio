    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            SellereX · Common UI Design System
          </span>
        </div>
      ...
      >
        <Image
          src="/mockups/sellerex-common-mockup.jpg"
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 11, color: "var(--fg-2)" }}>
              Enterprise design token hub, semantic color palettes, and standardized React/TypeScript primitives.
            </span>
          </div>
